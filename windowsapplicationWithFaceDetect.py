...
def update_image(img):
   # Assuming target_width and target_height are the desired dimensions
    target_width, target_height = 800, 600  # Adjust as needed
...
def select_images():
    # Add these lines to define target_width and target_height
    target_width, target_height = 800, 600  # Adjust as needed
    ...
    if file_path:
        ...
        frame = age_gender_detector(img, faceNet, ageNet, genderNet)
        update_image(frame)
